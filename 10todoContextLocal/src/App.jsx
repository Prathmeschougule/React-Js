...
import TodoForm from './Component/TodosForm'
import TodoItem from './Component/TotoItem'
...
function App() {
 ...
 const toggleComplete=(id)=>{
    useTodos((prev)=>prev.map((prevTodo)=>prevTodo.id===id?{...prevTodo,completed:!prevTodo.completed}:prevTodo))   
 }
